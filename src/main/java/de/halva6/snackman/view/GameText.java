...
public class GameText
{
	...
	public GameText(GraphicsContext gc, int xOffset)
	{
		...
		this.text_x = xOffset;
		this.text_y = Controller.WIDTH * Controller.SPRITE_SIZE + Controller.SCORE_HEIGHT
				- (Controller.SCORE_HEIGHT / 2) + (fontHeight / 2);
	}
