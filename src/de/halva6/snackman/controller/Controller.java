...
public class Controller extends Application
{
	...
	public void start(Stage stage)
	{
		...
		Scene gameScene = new Scene(root, WIDTH * SPRITE_SIZE, HEIGHT * SPRITE_SIZE + SCORE_HEIGHT, Color.BLACK);
		gameScene.setOnKeyPressed(input.getEvent());
		gameScene.setOnKeyReleased(input.getEvent());

		stage.setScene(gameScene);

		Canvas canvas = new Canvas(WIDTH * SPRITE_SIZE, HEIGHT * SPRITE_SIZE + SCORE_HEIGHT);
